  ...
  return (
    <section id="epreuves" className="py-20 bg-light-gray">
      <div className="container mx-auto px-4">
        <h2 className="section-title">Épreuves BTS</h2>
        
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          {/* Épreuve E4 */}
          <div>
            <div className="card">
              <h3 className="text-2xl font-bold mb-4 text-dark-blue">Épreuve E4</h3>
              ...
              <div className="overflow-x-auto">
                <table className="min-w-full border-collapse">
                  <thead>
                    <tr>
                      <th className="border py-2 px-3 bg-dark-blue text-white text-left">Compétence</th>
                      <th className="border py-2 px-3 bg-dark-blue text-white text-left">Description</th>
                    </tr>
                  </thead>
                  <tbody>
          ...
          <div>
            <div className="card">
              <h3 className="text-2xl font-bold mb-4 text-dark-blue">Épreuve E5</h3>
              <p className="text-gray-600 mb-6">
              ...
              <div className="space-y-6">
                {resumeData.examE5.map((item, index) => (
                  <div key={index} className="border-b pb-4 last:border-b-0 last:pb-0">
                    <h4 className="text-lg font-semibold text-dark-blue mb-2">{item.subject}</h4>
